                ...
                <ContentTemplate>
                    <div style="float: left; width: 100%;">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="nome">
                                            Nome Instrutor</label>

                                        <asp:TextBox ID="txtNomeInstrutor" runat="server" Columns="50" CssClass="form-control" MaxLength="50" Width="100%" TabIndex="1"></asp:TextBox>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="nome">
                                            Email</label>

                                        <asp:TextBox ID="txtEmailInstrutor" runat="server" Columns="50" CssClass="form-control" MaxLength="50" Width="100%" TabIndex="2"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <asp:TextBox ID="txtValor_Hora" runat="server" Columns="50" CssClass="form-control" MaxLength="50" Width="100%" TabIndex="3"></asp:TextBox>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="nome">
                                            Certificados
                                        </label>
                                        <asp:TextBox ID="txtCertificados" runat="server" Columns="50" CssClass="form-control" MaxLength="50" Width="100%" TabIndex="4"></asp:TextBox>
                        ...
                        <fieldset>
                            ...
                            <div>
                                <asp:DataGrid ID="dgInstrutor" runat="server" AutoGenerateColumns="False"
                                    ...
                                    Width="492px" AllowPaging="True" TabIndex="2" OnSelectedIndexChanged="dgInstrutor_SelectedIndexChanged">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonColumn CommandName="Select" DataTextField="EMAIL" HeaderText="EMAIL"><HeaderStyle Width="50%" /></asp:ButtonColumn>
                                        <asp:ButtonColumn CommandName="Select" DataTextField="VALOR_HORA" HeaderText="VALOR HORA"></asp:ButtonColumn>
                                        <asp:ButtonColumn CommandName="Select" DataTextField="CERTIFICADOS" HeaderText="CERTIFICADOS"></asp:ButtonColumn>
                                    </Columns>
                                </asp:DataGrid>
                            </div>
